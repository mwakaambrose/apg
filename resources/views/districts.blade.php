    ...
    <section class="page-title-area">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-8">
                    <h1 class="page-title">Districts of Acholi</h1>
                </div>
                <div class="col-auto">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="common-heading mb-30">
							<span class="tagline">
								<i class="fas fa-plus"></i> districts
							</span>
                            <h2 class="title">These are the districts in the acholi sub-region</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center fancy-icon-boxes">
                <div class="col-xl-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0s">
                    <div class="fancy-box-item mt-30">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="">Gulu</a></h4>
                ...
                <div class="col-xl-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fancy-box-item mt-30">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="">Kitgum</a></h4>
                            <p>From health centers to regional referrals</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fancy-box-item mt-30">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="">Pader</a></h4>
                            <p>Building the local film industry</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="fancy-box-item mt-30">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="">Agago</a></h4>
                            <p>The future is ICT, we recognize that, and are involved</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fancy-box-item mt-30">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="">Lamwo</a></h4>
                            <p>We are building the local farming capacities</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fancy-box-item mt-30">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="">Omoro</a></h4>
                            <p>We are building the local farming capacities</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fancy-box-item mt-30">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="">Amuru</a></h4>
                            <p>We are building the local farming capacities</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fancy-box-item mt-30">
                        ...
                        <div class="content">
                            <h4 class="title"><a href="">Nwoya</a></h4>
                            <p>We are building the local farming capacities</p>
                        </div>
                    </div>
                </div>
